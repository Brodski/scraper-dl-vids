...
@ranking_bp.route('/doItAllSully')
def doItAllSully_Route():
    return createToDoController.doItAllSully(isDebug=True, isEnd=True)
...
def bigBoyChannelDownloader_TEST_Route():
    metadata_Ytdl_list: List[Metadata_Ytdl] = ytdl.bigBoyChannelDownloader(
        [
            {
