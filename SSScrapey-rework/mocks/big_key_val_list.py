  ...
  "lck": [
    {
      "channel": "lck",
      "id": "5057810",
      "link_s3": "https://my-bucket-bigger-stronger-faster-richer-than-your-sad-bucket.s3.amazonaws.com/channels/vod-audio/lck/5057810/test_test_test-v5057810.mp3",
      "title": "test_test_test-v5057810.mp3"
    }
  ],
...
def get_big_key_val_list():
    return big_key_val_list