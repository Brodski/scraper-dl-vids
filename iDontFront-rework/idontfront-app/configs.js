...
module.exports = {
    ...
    S3_STATE_OVERVIEW_LIGHT_JSON : "/channels/completed-jsons/overview-state/light.json",
    S3_EACH_CHANNEL_JSON : "/channels/completed-jsons/each-channel/",
    S3_CUSTOM_METADATA_KEYBASE : '/channels/completed-jsons/custom-metadata/'
  };
