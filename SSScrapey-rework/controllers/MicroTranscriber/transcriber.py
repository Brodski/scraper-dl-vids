...
# relative_filename = env_varz.WHSP_A2T_ASSETS_AUDIO + vod.s3_audio

# audio_name = os.path.basename(audio_url) # A trick to get the file name. eg) filename = "Calculated-v5057810.mp
...
# # audio_http = urllib.parse.quote(audio_url)
# # relative_path, headers = urllib.request.urlretrieve(audio_http, relative_filename) # audio_url = Calcula
# relative_path, headers = urllib.request.urlretrieve(audio_url, relative_filename) # audio_url = Calculatec
# except:
# stack_trace = traceback. format_exc()
# logger(" (downloadAudio) FAILED !!!! (audio_url, relative_filename) =",
# logger (stack trace)

# (audio_url, relative_filename))
...
def downloadAudio(vod: Vod):
    ...
    try:
        # audio_http = urllib.parse.quote(audio_url)
        # relative_path, headers  = urllib.request.urlretrieve(audio_http, relative_filename) # audio_url = Calculated-v123123.ogg
