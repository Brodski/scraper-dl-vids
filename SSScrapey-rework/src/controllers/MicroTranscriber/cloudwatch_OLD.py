...
class Cloudwatch:
    ...
    LOG_STREAM_NAME = f'{env_varz.ENV}_{os.getenv("CONTAINER_ID")}_count{os.getenv("TRANSCRIBER_INSTANCE_CNT")}_{datetime.datetime.utcnow().strftime("%Y_%b_%d-%Hh_%M")}' if env_varz.ENV != "local" else "local"
